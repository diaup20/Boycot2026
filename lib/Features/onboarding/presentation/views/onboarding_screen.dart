...
//     return Scaffold(
//       appBar: AppBar(title: const Text('التوجيه')),
//       body:
//           // Padding(
...
//             child: PageView(
//               children: const [
//                 Center(child: Text('أهلاً بك في تطبيق المنتجات')),
//                 Center(
//                     child: Text('ابحث عن المنتجات بسهولة باستخدام الباركود')),
//                 Center(child: Text('تصفح البدائل والمعلومات التفصيلية')),
//               ],
//             ),
//           ),
//           Padding(
...
//               onPressed: () {
//                 context.read<OnboardingCubit>().complete().then((_) {
